...
In \cref{fig:adaptive_lr} learning results for different $p$ are displayed.\todo{Continue}

\todo{Say that the eignevalues are more useful now and say that the learning rate from before was double the biggest that is shown here.}
