...
So far, we have not touched on the spiking behaviour.
\todo[inline]{Biologically implausible. Wf learned is bad and very unrealistic biologically. Learning with rule adaptation works but only structurally aka scale. (as said in the supplement paper.) Therefore hand tuning required which is trash. Forcing with beta not really working as it is the L1 cost.}
