...
To begin, we look at the results for \cref{eq:toy_example}. We adjust our external input sequence $\bmu{c}(t)$ to excite each neuron to spike so we have a better picture of whole learning progress of all neurons.\\
In \cref{fig:Ws_intro} the ideal results are displayed again with the given external $c$ input.
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{../../plots/Learning/Wf_complex_c.pdf}
	\caption{}
