...
\rewrite{Optimality: This is even more to ask than from a conventional NN, Say in method bcs there it has already been proven if I am not mistaken}. This requirement would allow us to give a justified measure on how close we are replicating the brain's control power compared to our artificial implementation in specific circumstances\rewrite{sounds vague}.

\section{Benefits, Ethics and Sustainability}
\todi{Benefits?}

Neuromorphic hardware \& Energy efficiency?\\
