...
\subsubsection{Plasticity}
	...
	An unrelated but noteworthy part of plasticity concerns synaptic intelligence\cite{bibid}. As pf now this has only been implemented on \acp{ANN} with Feed-forward architecture\todo{really? nature paper nochmal lesen} but
...
\subsubsection{Learning Algorithms}
	...
	This unsupervised local learning rule is based on Hebb's principle observed in nature. Since then a plethora of variations have been proposed and demonstrated successful.\todo{Ref some variations}
